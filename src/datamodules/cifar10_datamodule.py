...
class CIFAR10DataModule(LightningDataModule):
    """Example of LightningDataModule for CIFAR-10 dataset.
    ...
    def __init__(
        ...
        self.transforms = transforms.Compose([transforms.ToTensor(),transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))])
